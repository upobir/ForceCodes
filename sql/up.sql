...
CREATE TABLE CITY (
    ...
    CONSTRAINT CITY_CNTRY_FK FOREIGN KEY(COUNTRY_ID) REFERENCES COUNTRY(ID)
);
...
CREATE TABLE PROBLEM (
    ...
    CONSTRAINT PRBLM_NUM_CHK CHECK(PROB_NUM >= 1)
);
...
CREATE TABLE BLOG_TAG (
    ...
    CONSTRAINT BLOGTAG_BLOG_FK FOREIGN KEY(BLOG_ID) REFERENCES BLOG_POST(ID),
